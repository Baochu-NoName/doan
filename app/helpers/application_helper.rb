module ApplicationHelper
  ...
  floored.times { output << image_tag('star-on.png', size:'16x16') }
  ...
  if (value - floored) == 0.5
      output << image_tag('half-star.png', size:'16x16')
  end
  ...
  #stars
  (5 - value).floor.times { output << image_tag('star-off.png', size:'16x16') }
  output.html_safe
end
