module ApplicationHelper
  ...
  floored.times { output << image_tag('star-on.png', size:'11x11') }
  ...
  if (value - floored) == 0.5
      output << image_tag('half-star.png', size:'11x11')
  end
  ...
  #stars
  (5 - value).floor.times { output << image_tag('star-off.png', size:'11x11') }
  output.html_safe
end
